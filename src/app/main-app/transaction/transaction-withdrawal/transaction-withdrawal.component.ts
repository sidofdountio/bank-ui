...
@Component({
  selector: 'app-transaction-withdrawal',
  standalone: true,
  ...
  styleUrl: './transaction-withdrawal.component.css'
})
export class TransactionWithdrawalComponent implements OnInit {
  ...
  onSave() {
    ...
    this.request.description = "RE. " + this.account.customer.lastName + " " + this.account.customer.firstName;
